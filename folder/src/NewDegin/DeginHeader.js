...
import Aritylogo from '../../src/img/Arity.jpg'
        ...
        <div>
            <div className='header sticky-top'>
                <div className='header-wraper'>
                    <div className='container'>
                        <div className='header-alltext align-items-center d-flex'>
                            <div className='arity-logo'>
                                <img src={Aritylogo} alt="" />
                            </div>
                            <div>
                                <h2 >Arity QR Code Generator</h2>
                            </div>
                            <div>
                                <button className='btn ml-auto'>Watch Demo</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className='header-menu'>
                <div className='header-wrapper'>
                    <div className='container'>
                        <div className='menu-listing border border-secondary'>
